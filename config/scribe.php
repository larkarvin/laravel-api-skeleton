...
return [
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'You can retrieve your token by using the Login and Request a token API Endpoint .',
    ],
     ...
     */
    'intro_text' => <<<INTRO
This documentation aims to provide all the information you need to work with our Task API.
